  ...
  <main class="main">
          ...
          <div class="col-lg-6 mb-4 mb-lg-0">
            <div class="badge-wrapper mb-3">
              <div class="d-inline-flex align-items-center rounded-pill border border-accent-light">
                ...
                <span class="badge-text me-3">Premium Smartphone Spare Parts</span>
              </div>
            </div>

            <h1 class="hero-title mb-4">Empowering Repair Shops Across Malaysia</h1>

            <p class="hero-description mb-4">VVINZ TOP CELLSPARE Sdn Bhd provides high-quality, cost-effective smartphone components to over 300 repair shops in KL/Selangor, with rapid delivery and trusted brands.</p>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-box">
              ...
              <div class="feature-content">
                <h3 class="feature-title">Extensive Inventory</h3>
                <p class="feature-text">We supply parts for major brands like iPhone, Samsung, Huawei, Oppo, Vivo, Xiaomi, and more, covering LCDs, batteries, charging boards, and full housing.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="feature-box">
              ...
              <div class="feature-content">
                ...
                <p class="feature-text">With branches in Sungai Buloh, Rawang, Subang, and Kepong, we ensure parts reach repair shops in under 30 minutes for quick repairs.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <div class="feature-box">
              ...
              <div class="feature-content">
                ...
                <p class="feature-text">Our mid-to-high-end parts, including Kupei batteries, match OEM quality at affordable prices, boosting repair shop confidence.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <h3>Unleashing Potential with Reliable Spare Parts</h3>
            <p class="fst-italic">
              Founded in 2014 as VVINZ TOP MARKETING Enterprise, we transitioned to VVINZ TOP CELLSPARE Sdn Bhd in 2018 to meet growing demand. With four branches in Sungai Buloh (2014), Rawang (2022), Subang (2024), and Kepong (2025), we aim to expand across Malaysia, inspired by MY DIY and 99speedmarket to bring quality parts to every city center.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Over 300 repair shop clients in KL/Selangor trust us for consistent supply.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Partnered with top brands like Kupei for stable, high-quality components.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>UExpanding online presence on Shopee, Lazada, TikTok, and Rednote.</span></li>
            </ul>
    ...
    <section id="how-we-work" class="how-we-work section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>How We Work</h2>
        <p>Delivering quality parts with efficiency and precision</p>
              ...
              <div class="content">
                ...
                <div class="card-body">
                  ...
                  <div class="step-content">
                    ...
                    <p>We maintain robust stock levels across all branches to meet diverse repair needs for brands like iPhone, Samsung, and Huawei.</p>
                  </div>
                </div>
              </div>
            ...
            <div class="process-item" data-aos="fade-up" data-aos-delay="300">
              <div class="content">
                ...
                <div class="card-body">
                  ...
                  <div class="step-content">
                    <h3>Sourcing & Quality Check</h3>
                    <p>We partner with trusted manufacturers like Kupei and conduct rigorous quality checks to ensure parts meet high standards.</p>
                  </div>
                </div>
              </div>
            </div><!-- End Process Item -->
            ...
            <div class="process-item" data-aos="fade-up" data-aos-delay="400">
              <div class="content">
                ...
                <div class="card-body">
                  ...
                  <div class="step-content">
                    <h3>Distribution</h3>
                    <p>Our logistics network ensures parts are delivered to repair shops within 30 minutes, minimizing downtime.</p>
                  </div>
                </div>
              </div>
            </div><!-- End Process Item -->
              ...
              <div class="content">
                ...
                <div class="card-body">
                  ...
                  <div class="step-content">
                    ...
                    <p>We provide ongoing support to help repair shops select the right parts and resolve issues quickly.</p>
                  </div>
                </div>
              </div>
            </div><!-- End Process Item -->
    ...
    <section id="services" class="services section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Services</h2>
        <p>Comprehensive solutions for smartphone repair shops</p>
      </div><!-- End Section Title -->
        ...
        <div class="row justify-content-center g-5">
          ...
          <div class="col-md-6" data-aos="fade-right" data-aos-delay="100">
            <div class="service-item">
              ...
              <div class="service-content">
                <h3>Screen & LCD Supply</h3>
                <p>We provide high-quality LCD screens for brands like iPhone, Samsung, Oppo, Vivo, and more, ensuring vibrant displays and durability.</p>
          ...
          <div class="col-md-6" data-aos="fade-left" data-aos-delay="100">
            <div class="service-item">
              ...
              <div class="service-content">
                ...
                <p>Our batteries and other high-performance options offer reliable power and longevity at competitive prices.</p>
                <!--<a href="#" class="service-link">
                  <span>Learn More</span>
                  <i class="bi bi-arrow-right"></i>
                </a>-->
          ...
          <div class="col-md-6" data-aos="fade-right" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="service-content">
                <h3>Charging & Power Components</h3>
                <p>We supply charging boards and power switches for seamless functionality across multiple smartphone brands.</p>
                <!--<a href="#" class="service-link">
                  <span>Learn More</span>
                  <i class="bi bi-arrow-right"></i>
                </a>-->
          ...
          <div class="col-md-6" data-aos="fade-left" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="service-content">
                <h3>Housing & Back Glass</h3>
                <p>Full housing sets and back glass replacements to restore devices to their original look and feel.</p>
                <!--<a href="#" class="service-link">
                  <span>Learn More</span>
                  <i class="bi bi-arrow-right"></i>
                </a>-->
          ...
          <div class="col-md-6" data-aos="fade-right" data-aos-delay="300">
            <div class="service-item">
              ...
              <div class="service-content">
                <h3>Online Retail Support</h3>
                <p>We’re expanding to Shopee, Lazada, TikTok, and Rednote to make our parts accessible nationwide.</p>
                <!--<a href="#" class="service-link">
                  <span>Learn More</span>
                  <i class="bi bi-arrow-right"></i>
                </a>-->
          ...
          <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-item">
              ...
              <div class="service-content">
                ...
                <p>Customized bulk orders for repair shops with over 300 clients in KL/Selangor, ensuring cost-effective solutions.</p>
                <!--<a href="#" class="service-link">
                  <span>Learn More</span>
                  <i class="bi bi-arrow-right"></i>
                </a>-->
          ...
          <div class="col-lg-6" data-aos="zoom-out" data-aos-delay="200">
            <div class="faq-contact-card">
              ...
              <div class="card-content">
                ...
                <p>Contact our team for personalized assistance or explore our FAQs for quick answers.</p>
